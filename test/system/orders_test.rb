...
class OrdersTest < ApplicationSystemTestCase
  ...
  test "check dynamic fields" do
    ...
    assert has_no_field? 'Experiation date'
    ...
    assert has_field? 'Experiation date'
    assert has_no_field? 'Po number'
  ...
  test "check order and delivery" do
    ...
    fill_in "Account number", with: "567894"
    ...
    assert_equal 'Ashraf Sadek <hmashrafujjaman@gmail.com>',   mail[:from].value
